...
Title.Text = "c00lgui FE v2 by LordMuhamad"
...
local function LODFG_fake_script() -- back.LocalScript 
...
coroutine.wrap(LODFG_fake_script)()
local function OZOZLL_fake_script() -- next.LocalScript 
...
coroutine.wrap(OZOZLL_fake_script)()
local function PRLM_fake_script() -- Owlhub.LocalScript 
...
coroutine.wrap(PRLM_fake_script)()
local function NJCAD_fake_script() -- topkekremake.LocalScript 
...
coroutine.wrap(NJCAD_fake_script)()
local function EUOL_fake_script() -- Opfinality.LocalScript 
...
coroutine.wrap(EUOL_fake_script)()
local function EPAF_fake_script() -- ScriptSpy.LocalScript 
...
coroutine.wrap(EPAF_fake_script)()
local function VWRVXBO_fake_script() -- Dex.LocalScript 
...
coroutine.wrap(VWRVXBO_fake_script)()
local function JEET_fake_script() -- Hydroxide.LocalScript 
...
coroutine.wrap(JEET_fake_script)()
local function BPUMVS_fake_script() -- audiologger.LocalScript 
...
coroutine.wrap(BPUMVS_fake_script)()
local function FUYZ_fake_script() -- InfiniteYieldFE.LocalScript 
...
coroutine.wrap(FUYZ_fake_script)()
local function UZOJP_fake_script() -- HarkedReborn.LocalScript 
...
coroutine.wrap(UZOJP_fake_script)()
local function XKFYCMQ_fake_script() -- Backdoorfinder.LocalScript 
...
coroutine.wrap(XKFYCMQ_fake_script)()
local function LGWBHGC_fake_script() -- headfling.LocalScript 
...
coroutine.wrap(LGWBHGC_fake_script)()
local function VTNUD_fake_script() -- UnanchPlr.LocalScript 
...
coroutine.wrap(VTNUD_fake_script)()
local function TJOFLE_fake_script() -- Ccanon.LocalScript 
...
coroutine.wrap(TJOFLE_fake_script)()
local function VDYGVE_fake_script() -- humanoidel.LocalScript 
...
coroutine.wrap(VDYGVE_fake_script)()
local function ITMGLF_fake_script() -- beechat.LocalScript 
...
coroutine.wrap(ITMGLF_fake_script)()
local function KLIELDE_fake_script() -- flingui.LocalScript 
...
coroutine.wrap(KLIELDE_fake_script)()
local function KCRYWNL_fake_script() -- breakchat.LocalScript 
...
coroutine.wrap(KCRYWNL_fake_script)()
local function CKYNPI_fake_script() -- commitoof.LocalScript 
...
coroutine.wrap(CKYNPI_fake_script)()
local function RLHVHO_fake_script() -- backflip.LocalScript 
...
coroutine.wrap(RLHVHO_fake_script)()
local function OCGXKW_fake_script() -- walkonwall.LocalScript 
...
coroutine.wrap(OCGXKW_fake_script)()
local function LVRSSET_fake_script() -- blackhole.LocalScript 
...
coroutine.wrap(LVRSSET_fake_script)()
local function XWNIY_fake_script() -- ClickTP.LocalScript 
...
coroutine.wrap(XWNIY_fake_script)()
local function YTYVLUC_fake_script() -- autism.LocalScript 
...
coroutine.wrap(YTYVLUC_fake_script)()
local function BWXC_fake_script() -- singtheme.LocalScript 
...
coroutine.wrap(BWXC_fake_script)()
local function IAOWD_fake_script() -- oldtopbar.LocalScript 
...
coroutine.wrap(IAOWD_fake_script)()
local function RKSQZF_fake_script() -- oldcharsounds.LocalScript 
...
coroutine.wrap(RKSQZF_fake_script)()
local function UPQB_fake_script() -- oldanim.LocalScript 
...
coroutine.wrap(UPQB_fake_script)()
local function FRDF_fake_script() -- oldplrlist.LocalScript 
...
coroutine.wrap(FRDF_fake_script)()
local function UQJBED_fake_script() -- oldgraphics.LocalScript 
...
coroutine.wrap(UQJBED_fake_script)()
local function ZGDARC_fake_script() -- oldcons.LocalScript 
...
coroutine.wrap(ZGDARC_fake_script)()
local function LSZDF_fake_script() -- oldcursor.LocalScript 
...
coroutine.wrap(LSZDF_fake_script)()
local function RYDX_fake_script() -- no5.LocalScript 
...
coroutine.wrap(RYDX_fake_script)()
local function GBLA_fake_script() -- no3.LocalScript 
...
coroutine.wrap(GBLA_fake_script)()
local function DGBR_fake_script() -- no2.LocalScript 
...
coroutine.wrap(DGBR_fake_script)()
local function OEXJ_fake_script() -- no.LocalScript 
...
coroutine.wrap(OEXJ_fake_script)()
local function OOTGY_fake_script() -- no4.LocalScript 
...
coroutine.wrap(OOTGY_fake_script)()
local function JQQMI_fake_script() -- Text.LocalScript 
	local script = Instance.new('LocalScript', Text)

	script.Parent.Text = "Thank you for using c00lgui reborn FE v2.\n \nNeed support or changelogs? \n \nJoin us : discord.gg/92Wb8yGEh9 \n \nPrepare for 12/07/2022 exploits raids! \n \nSpecial thanks to : Mokny, USD317, NiceMan And everyone from team c00lkidd! \n \nShoutout to MasterMZ for showcasing the script!"
end
coroutine.wrap(JQQMI_fake_script)()
local function KFJQRE_fake_script() -- CloseOpen.LocalScript 
...
coroutine.wrap(KFJQRE_fake_script)()
local function WRWSW_fake_script() -- c00lguiFE.LocalScript 
...
coroutine.wrap(WRWSW_fake_script)()
